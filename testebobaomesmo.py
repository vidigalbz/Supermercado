...
def tab_cadastro():
    ...
    # Seleção de função
    gerentin = Radiobutton(login, text="Gerente", variable=role_var, value="gerente")
    gerentin.pack(anchor='w', padx=20)  # Usando pack para consistência

    funcionario = Radiobutton(login, text="Funcionário", variable=role_var, value="funcionario")
    funcionario.pack(anchor='w', padx=20)  # Usando pack para consistência
...
def tab_estoque():
        ...
        botaoremover = Button(root, text="Remover produtos", width = 30, command=remocao_de_produtos)
